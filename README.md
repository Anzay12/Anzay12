...
himanshu = {
    ...
    "stack"      : ["Python", "XGBoost", "PostgreSQL", "Docker", "React"],
    "currently"  : "Building ML-driven quantitative trading systems 💹",
...
![Typing](https://readme-typing-svg.demolab.com?font=Fira+Code&size=14&pause=1000&color=A78BFA&center=true&vCenter=true&width=400&lines=Open+to+Internships+%26+Collaborations+👋;Let's+build+the+future+of+Quant+ML+🚀)
